...
class UserMyNotiSettingsPage extends StatefulWidget {
  const UserMyNotiSettingsPage({Key? key}) : super(key: key);

  @override
  State<UserMyNotiSettingsPage> createState() => _UserMyNotiSettingsPageState();
}

class _UserMyNotiSettingsPageState extends State<UserMyNotiSettingsPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: const [
        ...
        MyPageDivider(),
        MyPageSwitch(name: "관심등록 업체 새 게시물 알림", isOn: false),
