...
class CompMypageTab extends StatefulWidget {
  const CompMypageTab({Key? key}) : super(key: key);

  @override
  State<CompMypageTab> createState() => _CompMypageTabState();
}

class _CompMypageTabState extends State<CompMypageTab> {
  late Future<ApiResponse<GetCompMypageResult>> _getMypageFuture;
  ...
  void _loadMypage() {
    _getMypageFuture = getIt<ApiProfileComp>().mypage();
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiResponse<GetCompMypageResult>>(
        future: _getMypageFuture,
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return CompMypageTabContent(
...
class CompMypageTabContent extends StatefulWidget {
  final GetCompMypageResult data;
  final void Function() onProfileUpdated;
  const CompMypageTabContent(
      {Key? key, required this.data, required this.onProfileUpdated})
      : super(key: key);

  @override
  State<CompMypageTabContent> createState() => _CompMypageTabContentState();
}

class _CompMypageTabContentState extends State<CompMypageTabContent> {
  @override
  Widget build(BuildContext context) {
