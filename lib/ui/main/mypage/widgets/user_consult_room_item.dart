...
class UserConsultRoomItemWidget extends StatefulWidget {
  final UserConsultRoomItem item;
  final void Function() onRoomExited;
  const UserConsultRoomItemWidget(
      {Key? key, required this.item, required this.onRoomExited})
      : super(key: key);

  @override
  State<UserConsultRoomItemWidget> createState() =>
      _UserConsultRoomItemWidgetState();
}

class _UserConsultRoomItemWidgetState extends State<UserConsultRoomItemWidget> {
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, Routes.userConsulting);
      },
      onLongPress: () {
        showArea1InfoSheet();
      },
