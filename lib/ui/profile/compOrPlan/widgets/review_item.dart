...
class _ReviewItemWidgetState extends State<ReviewItemWidget> {
  late final Future<void> preloadImageFuture;

  Future<void> preloadImages() async {
    for (var imgUrl in widget.item.imgUrls) {
  ...
  void didChangeDependencies() {
    ...
    preloadImageFuture = preloadImages();
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: FutureBuilder<void>(
                  future: preloadImageFuture,
                  builder: (context, snapshot) {
                    if (snapshot.connectionState != ConnectionState.done) {
                      return const ReviewItemImagePlaceholderInList();
                    } else {
